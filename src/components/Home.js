...
class Home extends Component {
    handleSubmit = (e) => {
        ...
        // Redirects user to url stored in path:
    ...
    render() {
        return (
            <div className="main-content home">
                ...
                <p>
                    We have thousands of videos created by expert teachers on
                    web design and front end development. Our library is
                    continually refreshed with the latest on web technology so
                    you will never fall behind.
                </p>
                <hr />
